...
loaded_model = load_model("video_classi_model.h5")
...
def main():  
    ...
    if uploaded_file is not None:
        ...
        with open(os.path.join("C:/Users/dell/Desktop/",uploaded_file.name.split("/")[-1]),"wb") as f:
            f.write(uploaded_file.getbuffer())
        st.success("File Uploaded Successfully")
                       
        if st.button('Classify The Video'):
            # Construct the output video path.
            output_video_file_path = "C:/Users/dell/Desktop/video/"+uploaded_file.name.split("/")[-1].split(".")[0]+"_output1.mp4"
            with st.spinner('Wait for it...'):
                # Perform Action Recognition on the Test Video.
                predict_on_video("C:/Users/dell/Desktop/"+uploaded_file.name.split("/")[-1], output_video_file_path, SEQUENCE_LENGTH)
                ...
                os.chdir('C://Users/bdell/Desktop/video/')
            ...
            video_file = open("C:/Users/dell/Desktop/video/" + 'output4.mp4', 'rb') #enter the filename with filepath
